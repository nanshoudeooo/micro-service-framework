    ...
    <panel style="border:1px solid #ccc;margin-top:1.5px">
         <el-form ref="myForm" :model="org" :rules="rules" label-width="160px" class="bd-form">
          <el-form-item  class="rowline" label="上级机构" prop="parent">
               ...
               <input type="hidden" v-model="org.parent" ref="parent"/>
          </el-form-item>
         ...
         mounted:function(){
            ...
            this.$nextTick(function(){
                ...
                if(rowdatas && rowdatas.length > 0){
                        self.$$Http.post.call(self,'/admin/organization/getByID',{id:rowdatas[0].id})
                        .then(function(content){
                            self.$$Func.fillValue(content,self.org);
                            self.oldOrg = content;
                            if(content.parent==0){
                               self.org.parentName = "无";
                               self.oldOrg.parentName = "无";
                            }
                        },function(resp){
                            if(!resp.treated)
        ...
        methods:{
            ...
            submitForm:function(formName) {
              ...
              this.$refs[formName].validate(function(valid){
                if (valid) {
                     ...
                     //发送后台请求
                     self.$$Http.post.call(self,'/admin/organization/update',self.org)
            ...
            resetForm:function(formName) {
              this.$refs[formName].resetFields();
               this.$$Func.fillValue(this.oldOrg,this.org);
            }
        }
    }
</script>